        ...
        <html>
            <head>
                ...
                <body style="background: black">
                    ...
                    >
                        <h1 style="color: white; text-align: center; font-size: 50px;">Лабараторная 6 </h1>
                            <tr>
                                {
...
if __name__ == '__main__':
    ...
    app = APPLab()
    app.Add("Just For Testing", datetime.datetime(2024, 5, 1, 16, 25), "Message")
    app.Add("Just For Testing", datetime.datetime(2024, 6, 1, 16, 25), "Закрытие вклада")
